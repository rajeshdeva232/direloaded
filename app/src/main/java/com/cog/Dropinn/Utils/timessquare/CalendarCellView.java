...
package com.cog.Dropinn.Utils.timessquare;
...
public class CalendarCellView extends FrameLayout {
  ...
  private static final int[] STATE_UNSELECTABLE = {
          R.attr.tsquare_state_unselectable
  };
  ...
  protected int[] onCreateDrawableState(int extraSpace) {
    ...
    if (isSelectable) {
      ...
      mergeDrawableStates(drawableState, STATE_UNSELECTABLE);
    }
